 ...
 * @author Mrivem
 */
public class P32_BuscarAlumno extends javax.swing.JFrame {

    /**
     * Creates new form P32_BuscarAlumno
     */
    public P32_BuscarAlumno() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P32_BuscarAlumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new P32_BuscarAlumno().setVisible(true);
            }
        });
    }
